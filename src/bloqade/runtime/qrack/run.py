...
from bloqade.analysis.address import AddressAnalysis, AnyAddress
...
def pyqrack_execute(mt: ir.Method, args: Tuple[Any, ...], kwargs: Dict[str, Any]):
    ...
    memory = Memory(num_qubits, allocated=0, sim_reg=QrackSimulator(qubitCount=num_qubits, isTensorNetwork=False))
