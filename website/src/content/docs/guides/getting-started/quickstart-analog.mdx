---
title: Bloqade Analog Quick Start
description: A quick start guide for the analog quantum computing eDSL — geometries, waveforms, emulation, hardware, and analysis.
sidebar:
  label: Quick Start — Analog
  order: 4
---
...
<img src="/guides/analog/geometry-visualization.png" alt="Atom geometry visualization" style="width:50%" />
...
![Pulse sequence visualization](/guides/analog/pulse-sequence-visualization.png)
...
![Report visualization](/guides/analog/report-visualization.png)
...
[local-control]: /guides/getting-started/background/
[rydberg-hamiltonian]: /guides/getting-started/background/
