---
title: Digital Quantum Computing with Bloqade
description: A quick start guide for writing, optimizing, and running digital (gate-based) quantum programs with Bloqade.
sidebar:
  label: Quick Start — Digital
  order: 3
---

import { Aside } from '@astrojs/starlight/components';

This section provides the quick start guide for developing quantum programs represented by circuits using Bloqade. Circuits are a general-purpose and powerful way of representing arbitrary computations. For a few examples please refer to our [examples](/guides/digital/).

## Pick your frontend: choose a DSL

bloqade-circuit provides a number of different [domain specific languages (DSLs)](/guides/digital/dialects/) for writing quantum programs.
If you are unsure which one to choose, head over to the [DSL documentation](/guides/digital/dialects/) for an overview of all available ones.

If you are looking to write a circuit, we recommend giving [SQUIN](/guides/digital/dialects/squin/) a go.
...
A detailed tutorial of how to use TSIM for QEC workflows is available on the [STIM/TSIM dialect page](/guides/digital/dialects/stim/).
...
For more details on domain specific languages available in bloqade-circuits, please refer to the [dedicated documentation section on dialects](/guides/digital/dialects/).
We also recommend that you check out our [collection of examples](/guides/digital/), where we show some more advanced usage examples.

There is also some more documentation available on the [PyQrack simulation backend](/guides/digital/simulation/simulator-device/).

Finally, if you want to learn more about compilation and compiler passes, please refer to [this documentation page](/guides/digital/compilation/).
