---
title: Contributing
description: How to set up a development environment, run the tests, and follow Bloqade's code style and contribution guidelines.
sidebar:
  order: 11
---

Please see [Installation](/guides/getting-started/installation/) for instructions on how to set up your development environment.
