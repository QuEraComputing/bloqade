...
description: Why Bloqade uses its dot-intensive "builder" syntax, and how to think about it.
---

You may have noticed from the [Quick Start](/guides/analog/quick-start/) and [Tutorials](https://queracomputing.github.io/bloqade-analog-examples/latest/)
...
The [Standard Representation](/guides/analog/reference/standard/) is a nice flow chart that gives a high-level overview of the different steps and components in the builder syntax.
