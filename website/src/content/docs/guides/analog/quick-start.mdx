---
title: Quick Start
description: A self-contained tour of Bloqade Analog — geometries, waveforms, emulation, hardware, and analysis.
---
...
<div align="center">
  <img src="/guides/analog/quick_start/geometry-visualization.png" style={{ width: '50%' }} alt="Geometry Visualization" />
</div>
...
![Pulse sequence visualization](/guides/analog/quick_start/pulse-sequence-visualization.png)
...
To submit your program to hardware ensure you have your AWS Braket credentials loaded. You will need to use the [AWS CLI](https://aws.amazon.com/cli/) to do this.
...
![Report visualization](/guides/analog/quick_start/report-visualization.png)
...
[local-control]: /guides/analog/background/#local-control
