---
title: Tasks
description: Tasks are the unit of execution run by devices — locally or remotely.
---

import { Aside } from '@astrojs/starlight/components';

Tasks are generally executed by [devices](/guides/digital/simulation/simulator-device/).
