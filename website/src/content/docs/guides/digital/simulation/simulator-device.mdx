---
title: Simulation Devices
description: Run kernels locally with a simulation device and inspect results beyond what a QPU allows.
---

A simulation device can run a [task](/guides/digital/simulation/tasks/), such as executing a kernel.
