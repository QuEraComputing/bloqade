---
title: Dialects and Kernels
description: An overview of Bloqade's domain-specific languages (dialects) and how kernels work.
---
...
For a list of available dialects [see below](#available-dialects).

Once you have defined your kernel, you can inspect their Intermediate Representation (IR), apply different optimizations using compiler passes, or run them on a [(simulator) device](/guides/digital/simulation/simulator-device/).

<Aside type="note" title="Kernels & dialects in a nutshell">
...
<Aside type="note" title="Primer on Python decorators">
...
Also, we recommend having a look at [the Structural QUantum INstructions (SQUIN) dialect](/guides/digital/dialects/squin/) as it is the most general purpose dialect available and is centrally used in the compilation pipeline.
...
Have a look at the (growing) [examples collection](/guides/tutorials/), where you can find different implementations of quantum programs using different dialects.

### [squin](/guides/digital/dialects/squin/)
...
Have a look at [the dedicated documentation page](/guides/digital/dialects/squin/) and the corresponding [API reference](/api/latest/python/bloqade/squin/).
...
### [qasm2](/guides/digital/dialects/qasm2/)
...
More details can be found [here](/guides/digital/dialects/qasm2/).
Also, have a look at the full [qasm2 API reference](/api/latest/python/bloqade/qasm2/).
...
### [stim](/guides/digital/dialects/stim/)

For quantum error correction applications, you may want to use this dialect.
See this [documentation page](/guides/digital/dialects/stim/) for more details.
The full API documentation is [available here](/api/latest/python/bloqade/stim/).
