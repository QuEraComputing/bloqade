---
title: SQUIN
description: The Structural Quantum Instructions dialect — Bloqade's central DSL for digital quantum programs.
---

The Structural Quantum Instructions (SQUIN) dialect constitutes the central domain-specific language used in bloqade-circuit.
...
![main IR](/guides/digital/dialects/squin-ir-1.png)
...
For a complete list of all available gates, please see the [API reference](/api/latest/python/bloqade/squin/stdlib/simple/gate/).
...
![main_noisy IR](/guides/digital/dialects/squin-ir-2.png)
...
A full list of available noise channels can be found in the [API reference](/api/latest/python/bloqade/squin/stdlib/simple/noise/).
...
See the [API reference for broadcast](/api/latest/python/bloqade/squin/stdlib/broadcast/) for all the available functionality.
...
* [Tutorial: Circuits with Bloqade](/guides/tutorials/)
* [SQUIN API reference](/api/latest/python/bloqade/squin/)
* [Examples & Tutorials](/guides/tutorials/)
