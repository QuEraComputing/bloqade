---
title: QASM2
description: The Open Quantum Assembly Language (QASM2) dialects in Bloqade, and the extended dialect with parallelism.
---
...
![QFT IR](/guides/digital/dialects/qft-pprint.png)
...
![QFT QASM2](/guides/digital/dialects/qft-qasm2.png)
...
Instead, use a [NoisePass](/api/latest/python/bloqade/qasm2/passes/) in order to inject noise statements automatically according to a specific noise model.
