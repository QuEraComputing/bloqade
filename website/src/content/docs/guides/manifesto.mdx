---
title: Bloqade Manifesto
description: The vision behind Bloqade — composable, hardware-oriented, hybrid quantum programming built on Kirin.
sidebar:
  order: 10
---
...
If you are interested in contributing, please see the [contribution page](/guides/contributing/). If you are interested in exploring more about neutral atom quantum computing, check out some analog tutorials [here](https://queracomputing.github.io/bloqade-analog-examples/dev/), and some circuit tutorials [here](/guides/digital/). If you wish to work closer with QuEra, please feel free to reach out!
