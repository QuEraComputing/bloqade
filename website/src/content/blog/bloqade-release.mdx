---
title: Introducing Bloqade SDK for Python
date: 2023-12-15
authors:
  - John Long
  - Phillip Weinberg
  ...
  - Xiuzhe (Roger) Luo
excerpt: >-
  We're thrilled to announce the Python version of Bloqade, our SDK for Neutral
  Atom quantum computing — making it easier than ever to compose analog programs
  for QuEra's hardware and analyze the results.
---
...
![Smart documentation surfaced inline in the coding environment](/blog/smart-docs.gif)
...
![Interactive visualization of atom locations](/blog/locations-hover.gif)

![Selecting nodes in the interactive graph visualization](/blog/graph-select.gif)
...
![Visualizing measurement bitstring results](/blog/visualize-bitstrings.gif)

![Hovering over bitstring results for details](/blog/hover-bitstrings.gif)
