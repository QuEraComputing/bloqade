---
title: A new journey for Bloqade
date: 2025-03-01
authors:
  - Jonathan Wurtz
  - Xiuzhe (Roger) Luo
  ...
  - John Long
excerpt: >-
  We introduce the next generation of Bloqade — a hardware-oriented SDK for
  neutral atoms that adds gate-based digital computation alongside the analog
  mode you already know.
---
...
Bloqade is an open-source project and can be freely downloaded and modified; you can learn how to do so on [GitHub](https://github.com/QuEraComputing/bloqade#installation). If you want to see how to write programs with the new `bloqade` package, check out our [examples](https://bloqade.quera.com/latest/digital/). If you would like to learn more about QuEra Computing Inc., check out our [webpage](https://quera.com) as well as discover our many [academic publications and demonstrations](https://www.quera.com/news#publications).
