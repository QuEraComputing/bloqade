---
title: Simulating noisy circuits for near-term quantum hardware
date: 2025-07-30
authors:
  - Tyler A. Cochran
  - Luis A. Martinez
...
excerpt: >-
  Bloqade now ships circuit-level noise models that closely mimic QuEra's
  Gemini-class hardware, letting you optimize circuits and run feasibility
  checks before you hit real devices.
---
...
![cirq_utils_flowchart](/blog/flowchart.png)
...
![Noise annotation example. Two zone model](/blog/example_annotation.svg)
...
![GHZ circuit fidelity with different noise models](/blog/noisy_ghz_fidelity.svg)
